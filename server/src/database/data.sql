...
(1,4,"Vous voilà sur un trottoir gris, à côté d'un hôtel. Vous pouvez continuer sur la gauche, aller vers la droite, ou rentrer dans l'hôtel",null,17,"A gauche",null,null,21,"A droite",null,null,8,"Retourner dans l'hôtel",null,null),
...
(1,8,"Encore une pièce miteuse. Un homme vous regarde par dessus son journal. Vous vous dites qu'ils se ressemblent tous.",null,4,"le trottoir",null,null,9,"Prendre l'ascenseur",null,null,null,null,null,null),
...
(1,14,"Une fois l'homme vaincu, la chambre blanche ne semble pas très intéressante.",null,3,"Sortir par la fenêtre",1,1,11,"Sortir par la porte",null,null,null,null,null,null),
